...
API_DELAY_SECONDS = int(os.environ.get("API_DELAY_SECONDS", 0)) 

# 确保延迟时间是正整数，如果用户输入了非法的，使用默认值
if not isinstance(API_DELAY_SECONDS, int) or API_DELAY_SECONDS < 0:
    print(f"Warning: Invalid API_DELAY_SECONDS value '{API_DELAY_SECONDS}'. Using default of 0 seconds.", file=sys.stderr)
    API_DELAY_SECONDS = 0
